...
// マクロ定義
//*****************************************************************************
#define	TEXTURE_FILENAME	"data/PressStart2Ph.tga"	// 読み込むテクスチャファイル名
...
void DrawDebugProc(void)
{
	...
	XMFLOAT2 vPos(SCREEN_X * -0.5f + FONT_WIDTH * 0.5f,
		SCREEN_Y * 0.5f - FONT_HEIGHT * 0.5f);
	...
	for (char* pChr = &g_szDebug[0]; *pChr; ++pChr) {
		if (*pChr == '\n') {
			vPos.x = SCREEN_X * -0.5f + FONT_WIDTH * 0.5f;
			vPos.y -= FONT_HEIGHT;
			continue;
		}
